...
<link href="js/jquery.validateMyForm.1.5.css" rel="stylesheet" type="text/css" />

<meta name="Microsoft Theme" content="none">
<meta name="Microsoft Border" content="none">
<script type="text/javascript">
  $(document).ready(function(){
    $("#text_order_form").validateMyForm();
  });
</script>
</head>
...
<font face="Arial" color="#000080"><small>
        <?php if($msg) { echo $msg; } ?>
        <?php if(!$msg) { ?>
        Please fill in your information below.&nbsp;&nbsp; We shall contact you shortly
        <?php } ?>
    </small></font><br>
</p>
<?php if(!$msg) { ?>
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    ...
    <form method="POST" id="text_order_form" name="text_order_form" target="_self" action="textordertm.php" onSubmit="" webbot-action="--WEBBOT-SELF--">
      <!--webbot bot="SaveResults" s-email-format="TEXT/PRE" s-email-address="info@trademark.com.hk" b-email-label-fields="TRUE" s-builtin-fields="Date Time" u-confirmation-url="textconfirmation.htm" startspan --><input TYPE="hidden" NAME="VTI-GROUP" VALUE="0"><!--webbot bot="SaveResults" endspan i-checksum="43374" --><table border="0" cellpadding="0" cellspacing="0" width="88%" height="369">
      <input style="display: none" type="text" name="country" />
        ...
        <tr>
          ...
          <td width="67%" height="25"><font face="Arial" color="#000080"><small><input type="text" name="Name" size="30" class="required"></small></font></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="67%" height="18"><font face="Arial" color="#000080"><small><input type="text" name="E_mail" size="30" class="required"></small></font></td>
        </tr>
        <tr>
          <td width="33%" height="18"></td>
          <td width="67%" height="18"></td>
        ...
        <tr>
          <td width="33%" height="18"><font face="Arial" color="#000080"><small>Please selec</small></font>t&nbsp; 
          </td>
        ...
        <tr>
          ...
          <td width="67%" height="18"><input type="text" name="class" size="15"><small><small><font color="#0000FF" face="Arial"> &nbsp;<font size="1">
          </font> </font><font size="1" face="Arial" color="#000080">(class no.
          </font></small></small><font face="Arial" color="#000080" size="1">
          1-45)</font></td>
        </tr>
        <tr>
          <td width="132%" height="33" colspan="2"><font face="Arial" color="#000080"><small><small><small>Please 
          <a href="intcls/intcls1.htm" target="_top" style="color: rgb(0,0,128)">click</a> here if 
          you do not&nbsp; know the class number or just leave it blank and we will advise you of 
          the relevant class(es).</small></small></small></font></td>
        </tr>
        <tr>
          <td width="100%" height="18" colspan="2"></td>
        </tr>
    ...
    <p><small><small><font face="Arial" color="#000080">| <a href="payterm.htm" style="color: rgb(0,0,128)" target="_top">Payment terms</a> | </font></small></small></p>
