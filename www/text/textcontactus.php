...
<?php if(!$msg) { ?> 
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="399">
  <tr>
  ...
  <tr>
    ...
    <span style="font-size: 10.0pt">Unit A1, 16/F., Wincome Centre,</span></font></td>
  ...
  <tr>
    ...
    <p class="MsoNormal"><font face="Arial" color="#000080">
    <span style="font-size: 10.0pt">39 Des Voeux Road Central,</span></font></td>
    <td width="52%" height="12"></td>
  </tr>
  <tr>
    <td width="8%" height="5"></td>
    <td width="24%" height="5"></td>
    <td width="46%" height="5"><font face="Arial" color="#000080"><small>Central,</small></font></td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: rgb(255,255,255); border-left: medium none rgb(255,255,255); border-right: medium none rgb(255,255,255); border-top: thin none rgb(0,0,128); border-bottom: thin none rgb(0,0,128)" height="445">
  <tr>
    ...
    <form method="POST" id="text_contact_form" name="text_contact_form" target="_self" action="textcontactus.php" onSubmit="" webbot-action="--WEBBOT-SELF--">
      <!--webbot bot="SaveResults" s-email-format="TEXT/PRE" s-email-address="info@trademark.com.hk" b-email-label-fields="TRUE" s-builtin-fields="Date Time" u-confirmation-url="confirmation01.htm" startspan --><input TYPE="hidden" NAME="VTI-GROUP" VALUE="0"><!--webbot bot="SaveResults" endspan i-checksum="6561" -->
